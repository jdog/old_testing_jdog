...
var jdog = PAGE.extend(function(puppy, dog, console) {
	...
	var dtest = dog.test = {
		...
		, FLAG : ["%cJAY%c❄%cDOҨ","padding-left:10px; font-size:42px; color:rgb(229, 229, 209); font-weight:normal; background-color:#54E860; color:white;", "font-size:42px; color:rgb(72, 72, 138); background-color:#54E860; font-weight:normal;", "font-size:42px; color:rgb(229, 229, 209); font-weight:normal; background-color:#54E860; color:white; padding-right:10px;"]
	...
	dog.addTests = function(path, func /* (Constructor, Test, TestWaiter, comparer) */, isIntegration) {
		...
		function TestWaiter(testName, resultFunc /* (series, go, call) */ ) {
			...
			function go() {
				if (series.length > 0) {
					// pass the arguments along from previous to current
	...
	dog.addCoverage = function addCoverage(callback) {
		...
		PAGE.exists("Utils.CodeCoverage") ? "" : dog.loadScript("/Source/testUtils/jdog.codeCoverage.js")
